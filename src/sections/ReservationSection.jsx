                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 md:gap-y-8">
                  ...
                  <div className="space-y-1">
                    <div className="flex flex-col space-y-2">
                      <label className="text-[10px] md:text-xs font-bold uppercase tracking-widest text-primary">Fecha</label>
                      <input 
                        type="date" 
                  ...
                  <div className="space-y-1">
                    <div className="flex flex-col space-y-2">
                      <label className="text-[10px] md:text-xs font-bold uppercase tracking-widest text-primary">Hora</label>
                      <input 
                        type="time" 
                        className="input-field"
                        value={formData.time}
                  ...
                  <div className="space-y-1">
                    <div className="flex flex-col space-y-2">
                       <label className="text-[10px] md:text-xs font-bold uppercase tracking-widest text-primary">Escuadrón (Pax)</label>
                       <select 
                  ...
                  <div className="space-y-1">
                    <div className="flex flex-col space-y-2 text-text-bright">
                       <label className="text-[10px] md:text-xs font-bold uppercase tracking-widest text-primary">Zona de Desembarco</label>
                       <select 
                         className="input-field appearance-none"
